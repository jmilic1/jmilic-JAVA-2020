...
/**
 * Program used for animating a predefined scene using parallelization.
 * 
 * @author Jura Milić
 *
 */
public class RayCasterParallel2 {
	...
	/**
	 * Returns a IRayTracerAnimator which will animate the scene.
	 * 
	 * @return IRayTracerAnimator implementation
	 */
